...
export const RosterGenerator: React.FC<RosterGeneratorProps> = ({
  ...
  const handleSaveToSheet = async () => {
    ...
    try {
      ...
      const msg = `บันทึกตาราง${groupLabel} ประจำเดือน ${THAI_MONTHS[month]} ${thaiYear} จำนวน ${rows.length} รายการ ลง Google Sheet เรียบร้อยแล้ว (ลบข้อมูลเดือนอื่นออกแล้ว)`;
